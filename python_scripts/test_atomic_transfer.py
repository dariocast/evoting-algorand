...
mnemonic_1 = "head exile credit private couch special spawn also merry grant faith parent blade measure rigid mixed waste notice dizzy concert hidden nephew change absent emotion"
# account 1 as user
mnemonic_2 = "burger annual abstract dentist unable glad crash cannon wet long fringe cube dress devote hill ancient luggage apple unable van inspire lesson wine abstract timber"
# account 3
mnemonic_3 = "amazing squirrel lecture calm kick core regular skill lend flock mule audit mention orange toward search busy neutral record dilemma exile there tennis absent share"
